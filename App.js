...
export default class App extends React.Component {
    ...
    renderHeader = () => {
            ...
            if (!shouldShowStickyHeader) {
                return ( <
                    Animated.View style = {
                        [animatedViewStyle, animatedStyle]
                    } >
                    <
                    Icon reverse type = 'ionicon'
                    color = '#517fa4'
                    name = 'ios-american-football' /
                    >

                    <
                    Icon reverse color = '#f50'
                    name = 'heartbeat'
                    type = 'font-awesome' /
                    >
        ...
        //This is the change from Loc
        //git checkout -b pr-1-Loc
    ...
    render() {
        ...
        return ( <
            View style = { styles.container } > { shouldShowStickyHeader && this.renderStickyHeader() } <
            FlatList data = { rows }
